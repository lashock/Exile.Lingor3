...
_shorttext         = "Arma 3 Exile - MiSFiT Gaming";
_posText        = [0.8,0.5,0.4];


_title2         = "Website";
_shorttext2     = "www.misfit-gaming.com";
_posText2        = [0.8,0.5,0.25];


_title3            = "Teamspeak 3";
_shorttext3     = "ts.misfit-gaming.com";
...
_title4         = "Custom Scripts";
_shorttext5     = "Welcome Messages <br />Defent's Mission System<br />Custom Traders<br /> ";
