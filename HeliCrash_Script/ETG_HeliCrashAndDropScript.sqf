...
_DeletionDelay = 1200;										//Time the helicrashes/supply drops will stay and be deleted after (time in seconds)
...
_ETG_ScriptPath = "HeliCrash_Script/ETG_HeliCrashAndDropScript.sqf";
...
_ETG_StartionPositions = [[1.5243369,10238.133,0],[10104.245,10114.948,0],[10229.126,11.342163,0],[8.2280521,10.230103,0]];

//Edit this coordinate it should be roughly the center of the map you are playing on (this one is for Altis)
_CenterOfMap = [5123.4668,5100.1782,0];
...
////////////////////////////////////////////////////////////////
	...
	_ETG_Weapons = 			['CUP_hgun_Colt1911','CUP_hgun_Colt1911_snds','CUP_hgun_TaurusTracker455','CUP_hgun_TaurusTracker455_gold','CUP_hgun_Makarov','CUP_hgun_Compact','CUP_hgun_Duty','CUP_hgun_Duty_M3X','CUP_hgun_M9','CUP_hgun_M9_snds','CUP_hgun_Glock17','CUP_hgun_glock17_snds','CUP_hgun_Phantom','CUP_hgun_PB6P9','CUP_hgun_PB6P9_snds','CUP_hgun_MicroUzi','CUP_hgun_MicroUzi_snds','CUP_hgun_SA61','CUP_smg_bizon','CUP_smg_bizon_snds','CUP_smg_MP5SD6','CUP_smg_MP5A5','CUP_smg_EVO','CUP_sgun_M1014','CUP_sgun_Saiga12K','CUP_sgun_AA12','CUP_arifle_AK74','CUP_arifle_AK107','CUP_arifle_AKS74','CUP_arifle_AKS74U','CUP_arifle_AK74_GL','CUP_arifle_AKM','CUP_arifle_AKS','CUP_arifle_AKS_Gold','CUP_arifle_AK107_GL','CUP_arifle_Sa58P','CUP_arifle_Sa58V','CUP_arifle_Sa58P_des','CUP_arifle_Sa58V_camo','CUP_arifle_Sa58RIS1','CUP_arifle_Sa58RIS1_des','CUP_arifle_Sa58RIS2','CUP_arifle_Sa58RIS2_camo','CUP_arifle_CZ805_A1','CUP_arifle_CZ805_A2','CUP_arifle_CZ805_GL','CUP_arifle_CZ805_B_GL','CUP_arifle_CZ805_B','CUP_arifle_M16A2','CUP_arifle_M16A2_GL','CUP_arifle_M16A4_Base','CUP_arifle_M16A4_GL','CUP_arifle_M4A1','CUP_arifle_M4A1_camo','CUP_arifle_M4A1_BUIS_GL','CUP_arifle_M4A1_BUIS_camo_GL','CUP_arifle_M4A1_BUIS_desert_GL','CUP_arifle_M4A1_black','CUP_arifle_M4A1_desert','CUP_arifle_G36A','CUP_arifle_G36A_camo','CUP_arifle_G36K','CUP_arifle_G36K_camo','CUP_arifle_G36C','CUP_arifle_G36C_camo','CUP_arifle_Mk16_CQC','CUP_arifle_Mk20_SB11420_snds','CUP_arifle_XM8_Carbine_FG','CUP_arifle_XM8_Carbine_GL','CUP_arifle_XM8_Compact','CUP_arifle_FNFAL_railed','CUP_arifle_L85A2','CUP_arifle_L85A2_GL','CUP_arifle_FNFAL','CUP_arifle_Mk16_CQC_FG','CUP_arifle_Mk16_CQC_SFG','CUP_arifle_Mk16_CQC_EGLM','CUP_arifle_Mk16_STD','CUP_arifle_Mk16_SV','CUP_arifle_Mk17_CQC','CUP_arifle_Mk17_STD','CUP_arifle_Mk20','CUP_arifle_XM8_Compact_Rail','CUP_arifle_XM8_Railed','CUP_arifle_MG36','CUP_arifle_MG36_camo','CUP_lmg_L7A2','CUP_lmg_M60A4','CUP_lmg_M240','CUP_lmg_M249','CUP_lmg_PKM','CUP_arifle_RPK74','CUP_lmg_UK59','CUP_arifle_xm8_SAW','CUP_lmg_Pecheneg','CUP_lmg_L110A1','CUP_arifle_L86A2','CUP_lmg_M249_para','CUP_lmg_Mk48_des','CUP_lmg_Mk48_wdl','CUP_srifle_CZ550','CUP_srifle_LeeEnfield','CUP_srifle_M40A3','CUP_srifle_DMR','CUP_srifle_ksvk','CUP_srifle_M110','CUP_srifle_M14','CUP_srifle_M24_des','CUP_srifle_M24_wdl','CUP_srifle_SVD','CUP_srifle_SVD_des','CUP_srifle_VSSVintorez','CUP_srifle_AS50','CUP_srifle_AWM_des','CUP_srifle_CZ750','CUP_srifle_M107_Base','CUP_srifle_Mk12SPR'];
	_ETG_Items = 			['V_TacVestIR_blk','V_TacVestCamo_khk','V_TacVest_oli','V_TacVest_khk','V_TacVest_camo','V_TacVest_brn','V_TacVest_blk_POLICE','V_TacVest_blk','V_Rangemaster_belt','V_PlateCarrierSpec_rgr','V_PlateCarrierIAGL_dgtl','V_PlateCarrierIA2_dgtl','V_PlateCarrierIA1_dgtl','V_PlateCarrierGL_rgr','V_PlateCarrier3_rgr','V_PlateCarrier2_rgr','V_PlateCarrier1_rgr','V_PlateCarrier1_blk','V_HarnessOSpec_gry','V_HarnessOSpec_brn','V_HarnessOGL_gry','V_HarnessOGL_brn','V_HarnessO_gry','V_HarnessO_brn','V_Chestrig_rgr','V_Chestrig_oli','V_Chestrig_khk','V_Chestrig_blk','V_BandollierB_rgr','V_BandollierB_oli','V_BandollierB_khk','V_BandollierB_cbr','V_BandollierB_blk','ItemGPS','MineDetector','Rangefinder','CUP_SOFLAM','CUP_Vector21Nite','NVGoggles','Laserdesignator','FirstAidKit','I_UavTerminal','CUP_muzzle_PB6P9','CUP_muzzle_PBS4','CUP_muzzle_snds_M9','CUP_muzzle_snds_MicroUzi','CUP_muzzle_Bizon','CUP_muzzle_snds_G36_desert','CUP_muzzle_snds_G36_black','CUP_muzzle_snds_XM8','CUP_muzzle_snds_L85','CUP_muzzle_mfsup_SCAR_H','CUP_muzzle_snds_SCAR_H','CUP_muzzle_snds_SCAR_L','CUP_muzzle_snds_M14','CUP_muzzle_snds_M110','CUP_muzzle_snds_AWM','optic_Arco','acc_flashlight','acc_pointer_IR','CUP_acc_Flashlight','CUP_acc_Flashlight_desert','CUP_acc_Flashlight_wdl','CUP_acc_Glock17_Flashlight','CUP_acc_XM8_light_module','CUP_acc_CZ_M3X','CUP_acc_ANPEQ_2','CUP_acc_ANPEQ_2_grey','CUP_acc_ANPEQ_2_desert','CUP_acc_ANPEQ_2_camo','CUP_acc_ANPEQ_15','optic_Hamr','optic_SOS','optic_Holosight','optic_MRCO','optic_Nightstalker','optic_NVS','optic_DMS','optic_LRPS','optic_AMS','optic_KHS_hex','CUP_optic_Kobra','CUP_optic_RCO','CUP_optic_RCO_desert','CUP_optic_Eotech533Grey','CUP_optic_Eotech533','CUP_optic_ACOG','CUP_optic_SUSAT','CUP_optic_TrijiconRx01_black','CUP_optic_TrijiconRx01_desert','CUP_optic_CompM2_Desert','CUP_optic_CompM2_Woodland2','CUP_optic_CompM2_Woodland','CUP_optic_CompM2_Black','CUP_optic_CompM4','CUP_optic_HoloDesert','CUP_optic_HoloWdl','CUP_optic_HoloBlack','CUP_optic_MRad','CUP_optic_ZDDot','CUP_optic_SB_11_4x20_PM','CUP_optic_ELCAN_SpecterDR','CUP_optic_AN_PAS_13c1','CUP_optic_AN_PAS_13c2','CUP_optic_AN_PVS_4','CUP_optic_AN_PVS_10','CUP_optic_ElcanM145','CUP_optic_LeupoldMk4','CUP_optic_LeupoldMk4_MRT_tan','CUP_optic_LeupoldMk4_CQ_T','CUP_optic_LeupoldMk4_10x40_LRT_Woodland','CUP_optic_LeupoldMk4_10x40_LRT_Desert','CUP_optic_LeupoldM3LR','CUP_optic_Leupold_VX3','CUP_optic_CWS','CUP_optic_SB_3_12x50_PMII','CUP_optic_PechenegScope','CUP_optic_NSPU','CUP_optic_GOSHAWK','CUP_optic_PSO_3','CUP_optic_PSO_1','bipod_01_F_snd','bipod_01_F_blk','bipod_01_F_mtp','U_B_CombatUniform_mcam','U_B_CombatUniform_mcam_vest','U_B_GhillieSuit','U_Rangemaster','U_I_CombatUniform','U_I_CombatUniform_tshirt','U_I_Wetsuit','U_I_OfficerUniform','U_I_GhillieSuit','U_IG_Guerilla1_1','U_IG_Guerilla2_1','U_OG_Guerilla2_1','U_C_Journalist','V_Press_F','V_RebreatherIA','U_B_FullGhillie_lsh','U_B_FullGhillie_sard','U_B_FullGhillie_ard','U_O_FullGhillie_lsh','U_O_FullGhillie_sard','U_O_FullGhillie_ard','U_I_FullGhillie_ard','U_I_FullGhillie_sard','_PlateCarrierGL_blk','V_PlateCarrierGL_mtp','V_PlateCarrierSpec_blk','V_PlateCarrierSpec_mtp','V_PlateCarrierIAGL_oli'];
	...
	_ETG_WeaponMagazines =	['CUP_6Rnd_45ACP_M','CUP_7Rnd_45ACP_1911','CUP_8Rnd_9x18_Makarov_M','CUP_10Rnd_9x19_Compact','CUP_15Rnd_9x19_M9','16Rnd_9x21_Mag','CUP_17Rnd_9x19_glock17','CUP_18Rnd_9x19_Phantom','CUP_20Rnd_B_765x17_Ball_M','CUP_30Rnd_9x19_UZI','30Rnd_9x21_Mag','CUP_30Rnd_9x19_EVO','CUP_30Rnd_9x19_MP5','CUP_64Rnd_9x19_Bizon_M','CUP_8Rnd_B_Saiga12_74Slug_M','CUP_8Rnd_B_Beneli_74Slug','CUP_20Rnd_B_AA12_Pellets','CUP_20Rnd_B_AA12_74Slug','CUP_20Rnd_556x45_Stanag','CUP_20Rnd_762x51_CZ805B','CUP_20Rnd_762x51_FNFAL_M','CUP_20Rnd_762x51_B_SCAR','CUP_30Rnd_545x39_AK_M','CUP_30Rnd_762x39_AK47_M','CUP_30Rnd_556x45_Stanag','CUP_30Rnd_556x45_G36','30Rnd_556x45_Stanag','CUP_30Rnd_Sa58_M','CUP_50Rnd_UK59_762x54R_Tracer','CUP_75Rnd_TE4_LRT4_Green_Tracer_545x39_RPK_M','CUP_100Rnd_556x45_BetaCMag','CUP_100Rnd_TE4_LRT4_762x54_PK_Tracer_Green_M','CUP_100Rnd_TE4_LRT4_White_Tracer_762x51_Belt_M','CUP_100Rnd_TE4_Green_Tracer_556x45_M249','CUP_200Rnd_TE4_Green_Tracer_556x45_L110A1','CUP_5Rnd_127x99_as50_M','CUP_5Rnd_86x70_L115A1','CUP_5Rnd_762x51_M24','CUP_5x_22_LR_17_HMR_M','CUP_5Rnd_127x108_KSVK_M','CUP_10x_303_M','CUP_10Rnd_762x51_CZ750','CUP_10Rnd_762x54_SVD_M','CUP_10Rnd_127x99_m107','CUP_10Rnd_9x39_SP5_VSS_M','CUP_20Rnd_762x51_DMR','20Rnd_762x51_Mag','CUP_20Rnd_9x39_SP5_VSS_M','CUP_20Rnd_762x51_B_M110'];
		...
		//Waits until cargo is close to the ground and deletes the parachute	
			...
			//Spawn AI if wanted
				if (_AI_Crash) then {
					...
					{ 
						removeAllWeapons _x;
						_x addWeapon "CUP_arifle_CZ805_B";
						_x addMagazine ["CUP_20Rnd_762x51_CZ805B", 4];
						_x addMagazine ["CUP_20Rnd_TE1_Yellow_Tracer_762x51_CZ805B", 4];
					} forEach units group _HelicrashUnits;
...
//Run if its a heli crash
	if (_ETG_Mission_Type == "Heli_Crash") then [ {
		...
		//Create the heli and gives it a name
			...
			{ 
			removeAllWeapons _x;
			_x addWeapon "CUP_smg_EVO";
			_x addMagazine ["CUP_30Rnd_9x19_EVO", 2];
